const cardsData = [
    ...
    { frontTitle: "Какова структура клетки?", backImage: "img/cell-structure.jpg", backText: "Клетка состоит из мембраны, ядра, цитоплазмы и органелл, таких как митохондрии, рибосомы и другие." },
